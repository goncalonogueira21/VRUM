      ...
      >
        <app-card class="mt-4 ml-16 text-center">
          ...
          <v-card-text class="text-center">
            ...
            <h6 class="text-h6 mb-1 mt-4 text--secondary">
              About me
            </h6>


            <v-textarea flat solo class="ma-0 pa-0" hide-details
  ...
  export default {
    ...
    data() {
        return{
          user :{
            ...
            rating:'3',
            about:'Lorem ipsum dolor, sit amet consectetur adipisicing elit. Ratione dolorem deserunt veniam tempora magnam quisquam quam error iusto cupiditate ducimus, et eligendi saepe voluptatibus assumenda similique temporibus placeat animi dicta?'
          },
          readonly:true
        }
    },
    methods:{
      ...
      save(){
        ...
        this.readonly=!this.readonly
        axios.put("http://localhost:5000/users/" + this.user.username, payload)
            .then((response) => {
